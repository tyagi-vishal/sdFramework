...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        customParams: function (params) { return params; },
        ...
        icons: {
            AddButton:'glyphicon glyphicon-plus',
        ...
        onCheckAll: function () {
           ...
           // debugger;
            ...
            CheckUncheckAllFill("allcheck");
            return false;
        },
        onUncheckAll: function () {
          //   alert("Unallcheck");
            CheckUncheckAllFill("Unallcheck");
            return false;
        },
    ...
    BootstrapTable.LOCALES['en-US'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Showing %s to %s of %s records', pageFrom, pageTo, totalRows);
        },
        ...
        $.each(this.options.columns, function (i, column) {
            ...
            if (column.checkbox) {
                if (!that.options.singleSelect && that.options.checkboxHeader) {
                    text = '<input name="btSelectAll" id="btSelectAll" title="Select All"  type="checkbox"/>Select All';
                }
 ...
 if (this.options.showRefresh) {
     html.push(sprintf('<button class="btn btn-default btnAdd isAllow" type="button" onclick="AddNew()" name="Add" title="%s">',
                this.options.formateAdd()),
                sprintf('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.AddButton),
                '</button>');
        }
        ...
        if (this.options.search) {
            ...
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search">',
                    sprintf('<input class="form-control" name="search" type="text" placeholder="%s">',
    ...
    BootstrapTable.prototype.onSearch = function (event) {
        if (this.options.customParams.clickBtn == true)
        {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push(
            '<div class="pull-left pagination-detail">',
                ...
                '<select id="ddlactivate" class="btn btn-default dropdown-toggle" style="display:none;" ><option value="1">Activate</option><option value="0">Deactivate</option><option value="2">Delete</option></select>&nbsp;<button type="button" id="btnMassUpdate" onclick="MassUpdate()" class="btn btn-success"  style="display:none;">Go</button>&nbsp;&nbsp;&nbsp<span class="pagination-info">',
            ...
            $.each(this.header.fields, function (j, field) {
              ...
              //  debugger;
                if (column.checkbox || column.radio) {
                    ...
                    text = ['<td class="bs-checkbox" style="text-align: left;">',
                        '<input' +
                            sprintf(' data-index="%s"', i) +
                            sprintf(' name="%s"', that.options.selectItemName) +
                            //sprintf(' class="%s"', "chkItem") +
                            sprintf(' type="%s"', type) +
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        if (this.options.queryParamsType === 'limit') {
            params = {
                search: params.searchText == undefined ? '' : params.searchText,
                sort: params.sortName == undefined ? '' : params.sortName,
                order: params.sortOrder == undefined ? '' : params.sortOrder
            };
            if (this.options.pagination) {
        ...
        //Add Custom Paramaters : Added by vinay
        for (var prop in this.options.customParams) {
